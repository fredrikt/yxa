...
%%% Created : 16 Apr 2004 by Fredrik <ft@it.su.se>
...
get_addresses_for_user(Username) ->
	...
	Unknown ->
	    logger:log(error, "userdb-static: Unexpected result from phone:get_user(), user ~p result : ~p",
		       [Username, Unknown]),
	    error
    end.
