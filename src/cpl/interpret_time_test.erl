...
test() ->
    ...
    io:format("test: local_usec/0 - 1~n"),
    ...
    %%--------------------------------------------------------------------
    %% test regular range
    io:format("test: in_usec_range/3 - 1~n"),
    ...
    %% 
    io:format("test: in_time_range_test/3 - 1~n"),
    ...
    %% 
    io:format("test: in_time_range_test/3 - 2~n"),
...
test5() ->
    ...
    io:format("test: in_time_range_test/3 - 3~n"),
    ...
    io:format("test: in_time_range_test/3 - 4 WARNING: test assumes that local = EU~n"),
    ...
    io:format("test: in_time_range_test/3 - 5 WARNING: test assumes that local = EU~n"),
    ...
    io:format("test: in_time_range_test/3 - 6 WARNING: test assumes that local = EU~n"),
    ...
    io:format("test: in_time_range_test/3 - 7 WARNING: test assumes that local = EU~n"),
...
test6() ->
    ...
    io:format("test: in_time_range_5/3 - 1~n"),
    Current1a = ts_datetime:datetime_to_usec(start, dummy, 
    ...
    io:format("test: in_time_range_5/3 - 2~n"),
    ...
    io:format("test: in_time_range_5/3 - 3~n"),
    ...
    io:format("test: in_time_range_5/3 - 4~n"),
    ...
    io:format("test: in_time_range_5/3 - 5~n"),
...
test7() ->
    ...
    io:format("test: get_count__range_5/2 - 1~n"),
    Cond1 = #time_switch__cond_5{
      dtstart = #date_time{date = {2005,1,3}, time = {8,0,0}, type = floating}, 
      dtend_duration = {duration, #duration{hours = 8, minutes = 40}},
      freq = weekly, 
    ...
    io:format("test: get_count__range_5/2 - 2~n"),
    Cond2 = #time_switch__cond_5{
      dtstart = #date_time{date = {2005,1,3}, time = {8,0,0}, type = floating}, 
      dtend_duration = {duration, #duration{hours = 8, minutes = 40}},
      freq = weekly, 
    ...
    io:format("test: get_count__range_5/2 - 3~n"),
    ...
    io:format("test: get_count__range_5/2 - 4 - WARNING: test assumes that local = EU~n"),
    ...
    io:format("test: get_count__range_5/2 - 5 - WARNING: test assumes that local = EU~n"),
    ...
    io:format("test: get_count__range_5/2 - 6~n"),
    ...
    io:format("test: get_count__range_5/2 - 7~n"),
...
test8() ->
    ...
    io:format("test: in_time_range/3 - 3a~n"),
    ...
    io:format("test: in_time_range/3 - 3b~n"),
...
test9() ->
    ...
    %%--------------------------------------------------------------------
    io:format("test: sort_byparam/1 - 1~n"),
    ByParams = [{byday, {-1,mo}}, 
		{byday, {all,tu}},
		{byday, {2,we}},
		{byday, {all,th}}, 
...
test12() ->
    ...
    %%--------------------------------------------------------------------
    io:format("test: get_level_params/2 - 1~n"),
...
test13() ->
    ...
    %% remove bymonth
    io:format("test: get_next_level/2 - 1~n"),
...
test16() ->
    ...
    %% yearly
    io:format("test: create_startpoints/3 - 1~n"),
    ...
    %% monthly
    io:format("test: create_startpoints/3 - 2~n"),
    ...
    %% weekly
    io:format("test: create_startpoints/3 - 3~n"),
    ...
    %% daily
    io:format("test: create_startpoints/3 - 4~n"),
    ...
    %% hourly
    io:format("test: create_startpoints/3 - 5~n"),
    ...
    io:format("test: create_startpoints/3 - 6~n"),
    CSTimeSwitchCond6 = 
    ...
    io:format("test: create_startpoints/3 - 7~n"),
    CSTimeSwitchCond7 = 
	CSTimeSwitchCond1#time_switch__cond_7{dtstart = #date_time{date = {2005,5,1}, 
								   time = {0,2,3}, 
								   type = floating},
...
test17() ->
    ...
    %%--------------------------------------------------------------------
    %% bymonth
    io:format("test: create_startpoints/4 - 1~n"),
    ...
    %% byweekno
    io:format("test: create_startpoints/4 - 2~n"),
    ...
    %% byyearday
    io:format("test: create_startpoints/4 - 3~n"),
    ...
    %% bymonthday
    io:format("test: create_startpoints/4 - 4~n"),
    ...
    %% byday
    io:format("test: create_startpoints/4 - 5~n"),
    ...
    %% byhour
    io:format("test: create_startpoints/4 - 6~n"),
    ...
    %% byminute
    io:format("test: create_startpoints/4 - 7~n"),
    ...
    %% bysecond
    io:format("test: create_startpoints/4 - 8~n"),
...
test18() ->
    ...
    io:format("test: get_next_process_level/3 - 4.1~n"),
    bymonth = interpret_time:get_next_process_level(yearly, ByParams4, TSC4),
    io:format("test: get_next_process_level/3 - 4.2~n"),
...
test19_1() ->
    ...
    io:format("test: byxxx_match/2 - 1a~n"),
    ...
    io:format("test: byxxx_match/2 - 1b~n"),
    ...
    io:format("test: byxxx_match/2 - 1c~n"),
...
test19_2() ->
    ...
    %% first second
    io:format("test: byxxx_match/2 - 2a~n"),
    ...
    %% last second
    io:format("test: byxxx_match/2 - 2b~n"),
    ...
    io:format("test: byxxx_match/2 - 2c~n"),
    ...
    %% fail - day = su
    io:format("test: byxxx_match/2 - 2d~n"),
...
test19_3() ->    
    ...
    %% even second - fail
    io:format("test: byxxx_match/2 - 3a~n"),
    ...
    %% odd second
    io:format("test: byxxx_match/2 - 3b~n"),
...
test19_4() ->
    ...
    io:format("test: byxxx_match/2 - 4~n"),
...
test19_5() ->
    ...
    io:format("test: byxxx_match/2 - 5a~n"),
    ...
    io:format("test: byxxx_match/2 - 5b~n"),
    ...
    io:format("test: byxxx_match/2 - 5c~n"),
    ...
    io:format("test: byxxx_match/2 - 5d~n"),
...
test19_6() ->
    ...
    %% secondly
    io:format("test: byxxx_match/2 - 6a~n"),
    ...
    %% minutely
    io:format("test: byxxx_match/2 - 6b~n"),
    ...
    %% hourly
    io:format("test: byxxx_match/2 - 6c~n"),
    ...
    %% daily
    io:format("test: byxxx_match/2 - 6d~n"),
    ...
    %% weekly
    io:format("test: byxxx_match/2 - 6e~n"),
    ...
    %% monthly
    io:format("test: byxxx_match/2 - 6f~n"),
    ...
    %% yearly
    io:format("test: byxxx_match/2 - 6g~n"),
...
test19_7() ->
    ...
    %% even day - fail
    io:format("test: byxxx_match/2 - 7a~n"),
    ...
    %% odd time units
    io:format("test: byxxx_match/2 - 7b~n"),
    ...
    io:format("test: byxxx_match/2 - 7c~n"),
...
test19_8() ->
    ...
    %% secondly
    io:format("test: byxxx_match/2 - 8a~n"),
    ...
    %% minutely
    io:format("test: byxxx_match/2 - 8b~n"),
    ...
    %% hourly
    io:format("test: byxxx_match/2 - 8c~n"),
    ...
    %% daily
    io:format("test: byxxx_match/2 - 8d~n"),
    ...
    %% weekly
    io:format("test: byxxx_match/2 - 8e~n"),
    ...
    %% monthly
    io:format("test: byxxx_match/2 - 8f~n"),
    ...
    %% yearly
    io:format("test: byxxx_match/2 - 8g~n"),
...
test19_9() ->
    ...
    %% 
    io:format("test: byxxx_match/2 - 9.1~n"),
    ...
    %% 
    io:format("test: byxxx_match/2 - 9.2~n"),
    ...
    %% 
    io:format("test: byxxx_match/2 - 9.3~n"),
    ...
    io:format("test: byxxx_match/2 - 9.4~n"),
    ...
    io:format("test: byxxx_match/2 - 9.5~n"),
...
test20() ->
    ...
    io:format("test: in_time_range_test/2 - 1a~n"),
    ...
    io:format("test: in_time_range_test/2 - 1b~n"),
    ...
    io:format("test: in_time_range_test/2 - 1c~n"),
    ...
    io:format("test: in_time_range_test/2 - 1d~n"),
...
test21_1() ->
    io:format("test: get_count_ranges_7/2 - 1~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
      dtstart = #date_time{date = {2005,1,2}, time = {0,0,0}, type = floating},  
...
test21_2() ->
    io:format("test: get_count_ranges_7/2 - 2~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
      dtstart = #date_time{date = {2005,1,2}, time = {0,0,0}, type = floating},  
      dtend_duration = {duration, #duration{seconds = 1}},
...
%% byweekno
test21_3() ->
    io:format("test: get_count_ranges_7/2 - 3~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
...
test21_4() ->
    io:format("test: get_count_ranges_7/2 - 4~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
      dtstart = #date_time{date = {2005,1,2}, time = {12,12,12}, type = floating},  
      dtend_duration = {duration, #duration{seconds = 1}},
...
%% bymonthday
test21_5() ->
    io:format("test: get_count_ranges_7/2 - 5~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
      dtstart = #date_time{date = {2005,1,2}, time = {12,12,12}, type = floating},  
      dtend_duration = {duration, #duration{seconds = 1}},
...
%% byday
test21_6() ->
    io:format("test: get_count_ranges_7/2 - 6~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
...
test21_7() ->
    io:format("test: get_count_ranges_7/2 - 7~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
...
test21_8() ->
    io:format("test: get_count_ranges_7/2 - 8~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
...
%% yearly
test21_9() ->
    io:format("test: get_count_ranges_7/2 - 9~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
...
test21_10() ->
    io:format("test: get_count_ranges_7/2 - 10~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
...
test21_11() ->
    io:format("test: get_count_ranges_7/2 - 11a~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
    ...
    io:format("test: get_count_ranges_7/2 - 11b~n"),
...
test21_12() ->
    io:format("test: get_count_ranges_7/2 - 12~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
      dtstart = #date_time{date = {2003,12,9}, time = {22,12,1}, type = floating},  
      dtend_duration = {duration, #duration{hours = 15}},
...
%% hourly
test21_13() ->
    io:format("test: get_count_ranges_7/2 - 13~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
...
%% minutely
test21_14() ->
    io:format("test: get_count_ranges_7/2 - 14~n"),
    Timezone = dummy,
    TimeSwitchCond = #time_switch__cond_7{
...
test24a() ->
    ...
    %% get first and last
    io:format("test: get_bysetpos/2 - 1~n"),
    TimeSwitchCond1 = TimeSwitchCond#time_switch__cond_8{
    ...
    io:format("test: get_bysetpos/2 - 2~n"),
    TimeSwitchCond2 = TimeSwitchCond#time_switch__cond_8{
    ...
    io:format("test: get_bysetpos/2 - 3~n"),
    TimeSwitchCond3 = TimeSwitchCond#time_switch__cond_8{
			by_values = [{bymonthday, 2}, {bymonthday, 4},
				     {bymonthday, 16}, {bymonthday, 31}],
			bysetpos = [2,-3,5,-5]},
...
test24b() ->
    ...
    io:format("test: get_bysetpos/2 - 4~n"),
    ...
    io:format("test: get_bysetpos/2 - 5~n"),
...
test25() ->
    ...
    %% N = 1 / -5
    io:format("test: is_start_time_valid_bysetpos/2 - 1~n"),
    ...
    %% N = 2 / -4, fail
    io:format("test: is_start_time_valid_bysetpos/2 - 2~n"),
    ...
    %% N = 3 / -3, fail
    io:format("test: is_start_time_valid_bysetpos/2 - 3~n"),
    ...
    %% N = 4 / -2
    io:format("test: is_start_time_valid_bysetpos/2 - 4~n"),
    ...
    %% = 5 / -1
    io:format("test: is_start_time_valid_bysetpos/2 - 5~n"),
    ...
    io:format("test: is_start_time_valid_bysetpos/2 - 6~n"),
    ...
    io:format("test: is_start_time_valid_bysetpos/2 - 7~n"),
    ...
    io:format("test: is_start_time_valid_bysetpos/2 - 8~n"),
...
test26a() ->
    ...
    io:format("test: is_current_time_valid_bysetpos/2 - 1~n"),
    ...
    io:format("test: is_current_time_valid_bysetpos/2 - 2~n"),
    ...
    io:format("test: is_current_time_valid_bysetpos/2 - 3~n"),
...
test26b() ->
    ...
    %% N = 2 / -1
    io:format("test: is_current_time_valid_bysetpos/2 - 4~n"),
    C1 = #date_time{date = {2005,5,27}, time = {0,0,0}, type = floating},
    Current1 = ts_datetime:datetime_to_usec(start, Timezone, C1),
    true = interpret_time:is_current_time_valid_bysetpos(TimeSwitchCond, Current1),

    %% N = 1 / -2
    io:format("test: is_current_time_valid_bysetpos/2 - 5~n"),
...
test27() ->
    ...
    io:format("test: in_time_range/3 - 4~n"),
...
test28() ->
    ...
    io:format("test: get_count_ranges_8/2 - 1~n"),
